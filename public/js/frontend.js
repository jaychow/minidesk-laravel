    ...
    methods: {
        ...
        formatLegend: function formatLegend() {
            ...
            if (length > 0 && this.index < length && this.index > 0) {
                return "<span style='color:#455a64font-weight:600'>" + this.index + "</span>: <b>O</b> " + Number(this.open).toFixed(4) + " <b>H</b> " + Number(this.high).toFixed(4) + " <b>L</b> " + Number(this.low).toFixed(4) + " <b>C</b> " + Number(this.close).toFixed(4) + "<br/>" + "<b>Vol</b> " + this.jsonHistoryData[length - this.index - 1][6].toLocaleString() + " <b>Avg Vol</b> " + this.jsonHistoryData[length - this.index - 1][7].toLocaleString() + " <b>Delta O-C(%)</b> " + Number(this.jsonHistoryData[length - this.index - 1][8]).toFixed(2) + "% <b>Range(L-H)</b> " + Number(this.jsonHistoryData[length - this.index - 1][9]).toFixed(4) + " <b>Avg Vol(%)</b> " + Number(this.jsonHistoryData[length - this.index - 1][10]).toFixed(2) + "%";
            } else {
                return "<span style='color:#455a64font-weight:600'>" + this.index + "</span>: <b>O</b> ------ <b>H</b> ------ <b>L</b> ------ <b>C</b> ------<br/>" + "<b>Vol</b> ------ <b>Avg Vol</b> ------ <b>Delta O-C(%)</b> ------% <b>Range(L-H)</b> ------ <b>Avg Vol(%)</b> ------% ";
            }
        },
        formatYAxis: function formatYAxis() {
            if (this.jsonHistoryData.length > 0) {
                var currency = (this.value + 100) / 100 * this.jsonHistoryData()[0][5];
                return "$ " + (Math.round(currency * 10000) / 10000).toFixed(4);
            }
        },
        formatYLabel: function formatYLabel() {
            if (this.jsonHistoryData.length > 0) {
                var currency = (this.value + 100) / 100 * this.jsonHistoryData()[0][5];
                return (Math.round(currency * 10000) / 10000).toFixed(4);
            }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "chart", attrs: { id: "chart" } })
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
  ...
  return _c("div", { staticClass: "sidebar" }, [
    ...
    _c("div", { staticClass: "amount-area" }, [
      _c("div", { staticClass: "currency-selector-container" }, [
        _c(
          "div",
          { staticClass: "currency-selector currency-selector__home" },
          [
            _c("h4", [_vm._v(" HOME CURRENCY")]),
            _vm._v(" "),
            _c(
              "select",
              {
        ...
        _c(
          "div",
          { staticClass: "currency-selector currency-selector__foreign" },
          [
            _c("h4", [_vm._v(" FOREIGN CURRENCY")]),
            _vm._v(" "),
            _c(
              "select",
              {
      ...
      _vm._m(1),
      _vm._v(" "),
      _c("p", { attrs: { id: "tradeExplaination" } }),
      _vm._v(" "),
      _c(
        "button",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "buySellButton-area" }, [
      _c(
        "div",
        ...
        [
          ...
          _c(
            "button",
            {
              ...
              attrs: { value: "sell", id: "sellButton" }
            },
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("form", { attrs: { id: "tradingTicketForm" } }, [
...
/***/ "./resources/js/frontend/components/Chart/Footer.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./resources/js/frontend/components/Chart/Header.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./resources/js/frontend/components/Sidebar.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./resources/js/frontend/store/modules/chart.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chart_options__ = __webpack_require__("./resources/js/frontend/store/modules/chart/options.js");
...
/***/ "./resources/js/frontend/store/modules/chart/options.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
