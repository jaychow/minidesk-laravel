...
$(document).ready(function () {
    ...
    $('#refreshButton').on('click', function (e) {
        ...
        var fromDate = new Date(inputArg['fromDate']);
        var ymdToday = [];
        var ymdFromDate = [];
...
function requestData(argument) {
    ...
    $.get('http://minidesk.laravel.coretekllc.com/admin/chartzone/getTable', { pair: argument['pair'], timeRange: argument['timeRange'], utc: argument['utc'], fromTime: argument['fromDate'] }).done(function (data) {
        jsonData = data;
    ...
    switch (type) {
        case 'line':
            series.legendItem().format(function (e) {
                var length = jsonData.length;
                return "<span style='color:#455a64;font-weight:600'>" + this.index + "</span>: <b>Close</b> " + this.value + " <b>Delta O-C(%)</b> " + jsonData[length - this.index - 1][8];
            });
            break;
