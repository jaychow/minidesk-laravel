...
//            exit;
    ...
    public function dataProcess($type,$timeRange,$fromTime,$toTime)
    {
//        if($timeRange == '6M')
//            $close = Chart_day::orderBy('time', 'desc')->first();
//        }
//        else
//        {
//
...
//        }
    ...
    public function dataCheck($type,$timeRange,$fromTime,$toTime,$utc)
    {
        $from = Chart_hour::where('type', $type)->whereBetween('time', array($fromTime, $toTime))->min('time');
        $to = Chart_hour::where('type', $type)->whereBetween('time', array($fromTime, $toTime))->max('time');
